...
MATH_POSITIONS = {
    '/': {'col': 3, 'row': 2, 'character':'', 'image path': {'light': 'images/divide_white.ico', 'dark': 'images/divide_dark.ico'}},
...
OPERATORS = {
    ...
    'invert': {'col': 1, 'row': 2, 'text': '', 'image path': {'light': 'images/invert_white.ico', 'dark': 'images/invert_dark.ico'}},
